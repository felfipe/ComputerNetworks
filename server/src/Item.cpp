...
int ITEMS[14][8] = {
    {100, 0, 0, 0, 0, 0, 15, 0},    // IE
    {0, 100, 0, 0, 0, 0, 0, 15},    // Rabbadon
    {0, 0, 80, 0, 470, 0, 0, 0},    // Armadura de espinhos
    {0, 0, 0, 80, 500, 0, 0, 10},   // Semblante espiritual
    {0, 0, 0, 0, 1000, 0, 0, 10},   // Warmog
    {0, 60, 0, 0, 0, 0, 100, 40},   //Abraço de Seraph
    {0, 0, 20, 20, 0, 0, 55, 0},    //bota
    {90, 0, 0, 0, 0, 20, 15, 0},    //Rei destruido
    {75, 0, 120, 40, 50, 0, 0, 0},  // Cutelo Negro
    {0, 75, 0, 0, 120, 30, 0, 0},   //Tormento de Liandry
    {0, 40, 0, 60, 0, 0, 10, 0},    // Véu de Banshee
    {75, 0, 0, 0, 0, 0, 15, 0},     //Runnan
    {50, 0, 0, 0, 0, 35, 0, 10},    //Força da Trindade
    {0, 80, 0, 20, 150, 0, 0, 0}};  // Redenção
